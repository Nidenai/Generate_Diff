...
def test_rec():
    file_for_read = open('test/fixtures/test_rec_yaml.txt')
...
def test_plain():
    file_for_read = open('test/fixtures/test_plain_yaml.txt')
    path_one = 'test/fixtures/examples/file1_rec.yaml'
    path_two = 'test/fixtures/examples/file2_rec.yaml'
    result = file_for_read.read()
...
def test_json():
    file_for_read = open('test/fixtures/test_json_yaml.txt')
